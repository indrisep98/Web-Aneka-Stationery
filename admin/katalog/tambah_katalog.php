...
?>
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="forms">
          <h2 class="title1">Tambah Data Katalog Brand</h2>
          <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
            <div class="form-title">
              <h4>Form Tambah Data Katalog :</h4>
            </div>
            ...
            <div class="form-body">
                <form action="tambah_proses.php" method="post" enctype="multipart/form-data" class="form-horizontal"> 
                  <div class="form-group"> 
                    ...
                    <div class="col-sm-8"> 
                      <input type="text" name="nama_katalog" class="form-control" id="txtarea1" placeholder="Nama Katalog">
                    </div> 
                  </div> 
                  ...
                  <div class="form-group"> 
                    ...
                    <div class="col-sm-8"> 
                      <input type="file" name="file_katalog" class="form-control" placeholder="File Katalog">
                    </div> 
                  </div> 
                   <div class="form-group"> 
                    <label for="txtarea1" class="col-sm-2 control-label">Gambar Katalog</label> 
                    <div class="col-sm-8"> 
                      <input type="file" name="gambar_katalog" accept=".jpg, .png, .jpeg" class="form-control" placeholder="Gambar Katalog">
                    </div> 
                  </div> 
