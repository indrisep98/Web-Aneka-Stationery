...
?>
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          <h2 class="title1">Data Chat Pelanggan dan Admin</h2>
          <div class="table-responsive bs-example widget-shadow">
            <h4>Char dari Pelanggan</h4>
...
$sql="SELECT * FROM pesan_pelanggan;";
...
?>
               <tr> 
                ...
                <td>
                        <ul class="bt-list">
                          <a href="tambah_chat.php?id_pelanggan=<?php echo $data['id_pelanggan']; ?>" class="hvr-icon-grow-edit">Balas</a>
                        </div>
                      </div>
                    </div>
                  </div>
