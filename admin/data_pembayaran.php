...
?>
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          <h2 class="title1">Data Pembayaran</h2>
...
?>
               <tr> 
                ...
                <td> <img src="../login/bukti/<?php echo $data['bukti'] ?>" style="width: 100px; height: 80px">
                    <a href="../login/bukti/<?php echo $data['bukti']; ?>">Lihat</a>
                </td> 
                        </div>
                      </div>
                    </div>
